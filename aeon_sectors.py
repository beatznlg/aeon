...
TOOL_META[("agriculture", "irrigation")] = {
    "data_key": "irrigation",
    "id_field": "zone",
    "mock": [
...
TOOL_META[("education", "interventions")] = {
    "data_key": "plans",
    "id_field": "id",
    "mock": [
...
TOOL_META[("public_safety", "incidents")] = {
    "data_key": "incidents",
...
TOOL_META[("public_safety", "dispatch")] = {
    "data_key": "dispatch",
    "id_field": "unit_id",
    "mock": [
...
TOOL_META[("public_safety", "briefs")] = {
    "data_key": "briefs",
    "id_field": "id",
    "mock": [
...
TOOL_META[("real_estate", "valuations")] = {
    "data_key": "valuations",
    "id_field": "id",
    "mock": [
...
TOOL_META[("real_estate", "comparables")] = {
    "data_key": "comparables",
    "id_field": "id",
    "mock": [
...
TOOL_META[("professional", "legal")] = {
    "data_key": "legal_documents",
    "id_field": "doc",
    "mock": [
...
TOOL_META[("professional", "accounting")] = {
    "data_key": "accounting_audit",
    "id_field": "invoice_id",
    "mock": [
...
TOOL_META[("professional", "data-management")] = {
    "data_key": "data_management",
    "id_field": "dataset",
    "mock": [
...
TOOL_META[("logistics", "fleet")] = {
    "data_key": "fleet_status",
    "id_field": None,
    "mock": {
        "vehicles_active": 42,
        "vehicles_idle": 6,
...
TOOL_META[("legal", "contracts")] = {
    "data_key": "contract_review",
    "id_field": None,
    "mock": {
        "pending_review": 7,
        "flagged_clauses": [
...
TOOL_META[("insurance", "portfolio")] = {
    "data_key": "underwriting_portfolio",
    "id_field": None,
    "mock": {
...
TOOL_META[("construction", "projects")] = {
    "data_key": "projects",
    "id_field": "project_id",
    "mock": [
...
TOOL_META[("construction", "bids")] = {
    "data_key": "bid_pipeline",
    "id_field": "bid_id",
    "mock": [
