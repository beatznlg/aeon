...
const dashboards: Record<string, object> = {
  ...
  cybersecurity: {
    ...
    threats: [
      ...
      { id: "TH-002", indicator: "malware.exe", type: "Hash", severity: "critical", status: "quarantined" },
      { id: "TH-003", indicator: "phish.example.com", type: "Domain", severity: "medium", status: "monitored" },
    ],
    vulnerabilities: [
      { cve: "CVE-2024-0001", severity: "Critical", cvss: 9.8, affected: "example-lib", patch_available: true },
      { cve: "CVE-2024-0002", severity: "High", cvss: 7.5, affected: "auth-service", patch_available: false },
      { cve: "CVE-2024-0003", severity: "Medium", cvss: 5.3, affected: "api-gateway", patch_available: true },
    ],
    ip_reputation: {
      score: 0.18,
  ...
  retail: {
    ...
    supplier_risks: [
      { supplier: "Alpha Corp", risk_score: 15, classification: "Low Risk", on_time_delivery_pct: 96 },
      { supplier: "Beta Logistics", risk_score: 42, classification: "Medium Risk", on_time_delivery_pct: 82 },
      { supplier: "Gamma Wholesale", risk_score: 8, classification: "Low Risk", on_time_delivery_pct: 99 },
      { supplier: "Delta Distributors", risk_score: 71, classification: "High Risk", on_time_delivery_pct: 61 },
    ],
    price_elasticity: {
      sku: "SKU-001",
      price_change_pct: 10,
  ...
  manufacturing: {
    ok: true,
    maintenance: [
      { machine_id: "CNC-01", status: "good", temp_c: 42, vibration_hz: 12.5, failure_risk_pct: 12, days_to_failure: 45 },
      { machine_id: "CNC-02", status: "warning", temp_c: 58, vibration_hz: 18.2, failure_risk_pct: 34, days_to_failure: 12 },
      { machine_id: "CNC-03", status: "good", temp_c: 44, vibration_hz: 11.8, failure_risk_pct: 15, days_to_failure: 30 },
      { machine_id: "CNC-04", status: "critical", temp_c: 78, vibration_hz: 31.4, failure_risk_pct: 89, days_to_failure: 3 },
    ],
    qc: [
      { batch_id: "B-998", items_scanned: 500, defects_found: 10, defect_rate: 0.02, status: "pass" },
      { batch_id: "B-999", items_scanned: 500, defects_found: 35, defect_rate: 0.07, status: "fail" },
  ...
  professional: {
    ok: true,
    legal: [
      { doc: "Vendor_NDA.pdf", type: "NDA", risk_score: "low", obligations: ["5-year term", "standard confidentiality"] },
      { doc: "Client_MSA.pdf", type: "MSA", risk_score: "medium", obligations: ["auto-renewal", "liability cap review"] },
      { doc: "Employment_Contract.pdf", type: "Employment", risk_score: "low", obligations: ["IP assignment", "non-compete scope"] },
    ],
    accounting: [
      { invoice_id: "INV-102", vendor: "Alpha Services", amount: 12500, anomalies_detected: false, auto_approved: true },
      { invoice_id: "INV-103", vendor: "Beta Consulting", amount: 8400, anomalies_detected: true, auto_approved: false },
      { invoice_id: "INV-104", vendor: "Gamma Cloud", amount: 22000, anomalies_detected: false, auto_approved: true },
    ],
    data_management: [
  ...
  tourism: {
    ok: true,
    bookings: [
      { property: "Hotel-Central", occupancy_pct: 82, predictive_no_shows: 14, net_expected_occupancy: 78 },
      { property: "Hotel-West", occupancy_pct: 68, predictive_no_shows: 18, net_expected_occupancy: 64 },
      { property: "Hotel-Airport", occupancy_pct: 91, predictive_no_shows: 22, net_expected_occupancy: 89 },
    ],
    pricing: [
    ...
    concierge: [
      ...
      { guest_id: "G-446", sentiment: "neutral", intent: "housekeeping request", automated_response: "Housekeeping dispatched", upsell: null },
      { guest_id: "G-447", sentiment: "negative", intent: "transport to airport", automated_response: "Taxi booked for 6 AM", upsell: null },
    ],
  },
  ...
  transport: {
    ...
    fleet: [
      { vehicles_available: 10, shifts: 3, utilization_pct: 87, recommendation: "reduce 1 vehicle" },
      { vehicles_available: 8, shifts: 2, utilization_pct: 72, recommendation: "reduce 2 vehicles" },
      { vehicles_available: 15, shifts: 3, utilization_pct: 93, recommendation: "optimal" },
    ],
    route_plan: [
      { stops: ["A", "B", "C", "D", "E"], estimated_distance_km: 42, estimated_time_min: 55, fuel_cost_est: 18.50 },
      { stops: ["F", "G", "H", "I", "J"], estimated_distance_km: 38, estimated_time_min: 48, fuel_cost_est: 16.20 },
      { stops: ["K", "L", "M", "N", "O"], estimated_distance_km: 56, estimated_time_min: 72, fuel_cost_est: 24.80 },
    ],
  },
  ...
  finance: {
    ...
    fraud_cases: [
      { transaction_id: "TXN-5001", amount: 5000, fraud_score: 0.85, risk_level: "high", action: "blocked" },
      { transaction_id: "TXN-5002", amount: 35, fraud_score: 0.05, risk_level: "low", action: "approved" },
      { transaction_id: "TXN-5003", amount: 25000, fraud_score: 0.72, risk_level: "high", action: "flagged" },
    ],
    credit_applications: [
      ...
      { applicant_id: "APP-202", credit_score: 810, rating: "Excellent", approval_probability: 0.99 },
    ],
  },
  ...
  utilities: {
    ...
    energy_grid: [
      ...
      { region: "South Grid", current_load_mw: 312, capacity_mw: 300, utilization_pct: 104, renewable_share_pct: 22, status: "critical" },
  ...
  sme: {
    ok: true,
    workflow_data: [
      { process: "invoice_approval", employees_involved: 5, hours_saved_per_month: 120, cost_savings_annual: 24000 },
      { process: "employee_onboarding", employees_involved: 3, hours_saved_per_month: 80, cost_savings_annual: 16000 },
      { process: "report_generation", employees_involved: 2, hours_saved_per_month: 60, cost_savings_annual: 12000 },
    ],
    document_queue: [
      { document_type: "invoice", confidence: 0.97, pages_processed: 142, fields_extracted: ["vendor", "amount", "due_date"] },
      { document_type: "contract", confidence: 0.94, pages_processed: 38, fields_extracted: ["parties", "term", "liability"] },
      { document_type: "receipt", confidence: 0.96, pages_processed: 210, fields_extracted: ["merchant", "total", "date"] },
    ],
    support_tickets: [
