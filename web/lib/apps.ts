...
export const APPS: AeonApp[] = [
  ...
  },
  {
    ...
    color: "#06b6d4",
    status: "active",
    allowed_tools: ["diagnostic_analyzer","health_monitor","drug_interaction_check","medical_literature_search","telehealth_triage","fetch","search","math"],
    default_goals: [
  ...
  },
  {
    ...
    color: "#f97316",
    status: "active",
    allowed_tools: ["traffic_optimizer","fleet_scheduler","route_optimizer","congestion_forecast","smart_logistics","fetch","search","math"],
    default_goals: [
  ...
  },
  {
    ...
    color: "#22c55e",
    status: "active",
    allowed_tools: ["risk_assessment","payment_analyzer","market_forecast","fraud_detection","credit_scoring","fetch","search","math"],
    default_goals: [
  ...
  },
  {
    ...
    color: "#a855f7",
    status: "active",
    allowed_tools: ["visitor_engagement","cultural_heritage_guide","virtual_tour_guide","exhibition_planner","fetch","search","math"],
    default_goals: [
  ...
  },
  {
    ...
    color: "#eab308",
    status: "active",
    allowed_tools: ["resource_optimizer","public_service_monitor","waste_management","energy_grid_monitor","fetch","search","math"],
    default_goals: [
  ...
  },
  {
    ...
    color: "#14b8a6",
    status: "active",
    allowed_tools: ["workflow_automator","document_processor","customer_support_bot","supply_chain_analyzer","fetch","search","math"],
    default_goals: [
