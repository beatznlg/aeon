...
SECTOR_PACKS: tuple[SectorPack, ...] = (
    ...
    SectorPack(
        ...
        risk_level="medium",
        inference_policy=_grounded_policy(),
        allowed_task_types=("demand_forecast", "inventory_replenishment_plan", "pricing_analysis", "customer_segmentation", "promo_draft"),
        blocked_task_types=("autonomous_price_change", "autonomous_purchase_order", "autonomous_refund_approval"),
        output_schema=_GENERAL_SCHEMA,
        approved_model_tags=("private", "retail", "grounded", "calculation_verified"),
        notes=("Pricing and purchasing actions require human approval; outputs are forecasts and recommendations only.",),
    ),
    SectorPack(
        ...
        risk_level="medium",
        inference_policy=_grounded_policy(),
        allowed_task_types=("route_optimization_analysis", "eta_forecast", "capacity_planning", "carrier_comparison", "customs_doc_draft"),
        blocked_task_types=("autonomous_carrier_booking", "autonomous_route_commitment", "autonomous_customs_filing"),
        output_schema=_GENERAL_SCHEMA,
        approved_model_tags=("private", "logistics", "grounded"),
        notes=("Bookings, filings, and physical routing decisions remain with logistics operators.",),
    ),
    SectorPack(
        ...
        jurisdictions=("global",),
        risk_level="low",
        inference_policy=_grounded_policy(risk="low"),
        allowed_task_types=("guest_message_draft", "occupancy_forecast", "staffing_suggestion", "review_summarization", "revenue_analysis"),
        blocked_task_types=("autonomous_reservation_change", "autonomous_refund", "autonomous_guest_charge"),
        output_schema=_GENERAL_SCHEMA,
        approved_model_tags=("general", "hospitality", "grounded"),
        notes=("Guest-facing messages are drafts; reservations and charges always need staff confirmation.",),
    ),
    SectorPack(
        id="legal-services",
        version="1.0.0",
        ...
        risk_level="high",
        inference_policy=_regulated_policy(review=True),
        allowed_task_types=("case_law_retrieval_qa", "contract_review_draft", "clause_comparison", "discovery_summarization", "brief_outline"),
        blocked_task_types=("autonomous_legal_opinion_issuance", "autonomous_contract_execution", "autonomous_court_filing"),
        output_schema=_GENERAL_SCHEMA,
        approved_model_tags=("private", "legal", "provenance", "grounded"),
        notes=("Outputs are drafting and research assistance, not legal advice; licensed counsel review is required.",),
    ),
    SectorPack(
        ...
        risk_level="high",
        inference_policy=_regulated_policy(review=True),
        allowed_task_types=("claims_summary", "risk_scoring_analysis", "policy_qa", "fraud_flag_review", "loss_ratio_report"),
        blocked_task_types=("autonomous_claim_approval", "autonomous_pricing_decision", "autonomous_coverage_denial"),
        output_schema=_GENERAL_SCHEMA,
        approved_model_tags=("private", "insurance", "calculation_verified", "grounded"),
        notes=("Underwriting and claims decisions stay with licensed adjusters; AI outputs are analytical support.",),
    ),
    SectorPack(
        ...
        risk_level="medium",
        inference_policy=_grounded_policy(),
        allowed_task_types=("schedule_risk_analysis", "cost_estimate_draft", "rfp_summarization", "site_report_draft", "materials_comparison"),
        blocked_task_types=("autonomous_bid_submission", "autonomous_change_order_approval", "autonomous_site_directive"),
        output_schema=_GENERAL_SCHEMA,
        approved_model_tags=("private", "construction", "calculation_verified", "grounded"),
        notes=("Bids, change orders, and site directives are human decisions; estimates are advisory.",),
    ),
)
