...
class AeonClient:
    ...
    def chat(self, query: str, workspace_id: str | None = None, provider: str | None = None) -> dict[str, Any]:
    ...
    def create_workflow(
        self, *, name: str, nodes: list[dict[str, Any]], edges: list[dict[str, Any]], **kwargs: Any
    ) -> dict[str, Any]:
    ...
    # ── API Keys ─────────────────────────────────────────────────────────────
    def list_api_keys(self, workspace_id: str | None = None) -> dict[str, Any]:
        params = {"workspace_id": workspace_id} if workspace_id else None
        return self._get("/api-keys", params=params)

    def create_api_key(self, name: str, *, workspace_id: str | None = None, role: str = "operator") -> dict[str, Any]:
    ...
    def create_integration(self, *, type: str, name: str, config: dict[str, Any] | None = None) -> dict[str, Any]:
    ...
    def run_integration(
        ...
        return self._post(
            f"/integrations/{integration_id}/run", json={"endpoint": endpoint, "method": method, "payload": payload}
        )
